...
public class SwitchIcon implements AnimatedIcon {
  private int iconGap = 3;
  private int centerSpace = 5;

  private Icon darkIcon = new FlatSVGIcon("aomine/icons/switch_theme/dark.svg", 0.4f);
  private Icon lightIcon = new FlatSVGIcon("aomine/icons/switch_theme/light.svg", 0.4f);
